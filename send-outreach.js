...
const targets = [
  { email: 'info@newcourtland.org', name: 'NewCourtland Senior Centers' },
  { email: 'info@auroraathome.com', name: 'Aurora Home Care' }, // already sent but trying again with new template
];
