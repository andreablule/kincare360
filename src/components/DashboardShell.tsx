...
const allNavItems = [
  ...
  { label: "Care Info", href: "/dashboard/medical", icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z", roles: ["CLIENT","MANAGER","FAMILY","ADMIN"] },
  ...
  { label: "Appointments", href: "/dashboard/requests", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", roles: ["CLIENT","MANAGER","FAMILY","ADMIN"] },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-100 flex flex-col transform transition-transform duration-200 ease-in-out md:hidden ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="px-4 py-5 border-b border-gray-100 flex items-center justify-between">
          <Link href="/"><img src="/kincare360-logo.png" alt="KinCare360" className="h-28 w-auto" /></Link>
      ...
      <aside className="hidden md:flex md:flex-col md:w-64 bg-white border-r border-gray-100 fixed h-full">
        <div className="px-4 py-6 border-b border-gray-100">
          <Link href="/">
            <img src="/kincare360-logo.png" alt="KinCare360" className="h-32 w-auto" />
          </Link>
        </div>
