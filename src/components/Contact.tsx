      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-8 text-sm text-gray-500">
            <a href="tel:+18125155252" className="flex items-center gap-2 hover:text-teal transition-colors">
            ...
            <a href="mailto:hello@kincare360.com" className="flex items-center gap-2 hover:text-teal transition-colors">
              <svg className="w-5 h-5 text-teal" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
