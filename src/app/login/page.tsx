    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          Need help? Call <a href="tel:+12727669090" className="text-teal hover:underline">+1 272 766 9090</a> · <a href="mailto:hello@kincare360.com" className="text-teal hover:underline">hello@kincare360.com</a>
        </p>
      </div>
    </main>
  );
