...
export default function FamilyConsentPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      setResult({ type: "success", message: "Consent recorded. You are now enrolled to receive KinCare360 family updates, routine reminders, family concern notifications, and urgent safety concern notices by text message." });
    } catch (err: any) {
