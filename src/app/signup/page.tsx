  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <section className="rounded-2xl border border-teal/20 bg-teal/5 p-5 text-sm text-navy" aria-labelledby="signup-sms-consent-evidence">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mt-6">
          ...
          <form className="space-y-4" aria-label="KinCare360 signup form">
            ...
            <div className="flex items-start gap-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
              <input type="checkbox" id="smsConsent" defaultChecked={false} className="mt-1 h-4 w-4 rounded border-gray-300 text-teal" />
            ...
            <button type="button" className="w-full bg-teal text-white py-3.5 rounded-xl font-semibold text-sm">Create Account &amp; Continue →</button>
          </form>
        </div>
