...
function SignupForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
      {/* Referral badge */}
      {refParam && (
        <div className="bg-teal/10 border border-teal/20 rounded-xl px-4 py-3 text-center mb-6">
          {referrerName && (
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs"><span className="bg-white px-4 text-gray-400 uppercase tracking-wide">or sign up with email</span></div>
      </div>
