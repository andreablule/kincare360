          ...
          {step === 0 && (
            <div className="mt-6 max-w-md mx-auto">
              <button onClick={() => { 
                ...
                import("next-auth/react").then(m => m.signIn("google", { callbackUrl: "/intake" }));
              }}
                className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl px-4 py-3.5 text-sm font-medium text-navy hover:bg-gray-50 hover:border-gray-400 transition-all bg-white shadow-sm">
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs"><span className="bg-gray-50 px-4 text-gray-400 uppercase tracking-wide">or fill out the form below</span></div>
              </div>
            </div>
          )}
        </div>
