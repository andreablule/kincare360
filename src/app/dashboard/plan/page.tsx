...
const PLANS = [
  {
    ...
    price: "$99/mo",
    features: [
      "Daily family check-in calls",
      "Routine reminder calls",
      "Appointment reminders and coordination support",
      "Everyday service connection support",
      "Family concern notifications for non-medical follow-up",
      "Family dashboard",
      "24/7 access to Lily",
    ],
  },
  {
    ...
    features: [
      ...
      "Appointment reminders and coordination support for both parents",
      "Family dashboard with daily summaries and coordination notes",
