    ...
    <main className="max-w-3xl mx-auto px-4 py-16 text-navy">
      ...
      <section className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <p className="mt-2">In an emergency or immediate danger, call <strong>911</strong> immediately. Do not rely on KinCare360 for emergency response or urgent intervention. KinCare360 cannot guarantee response times and is not equipped to handle emergencies, investigations, emergency dispatch, or urgent professional intervention. By using our services, you acknowledge that KinCare360 shall have no liability for delays in communication or inability to respond to emergency situations.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">5. Family Follow-Up Notices</h2>
          <p>KinCare360 is not an emergency, crisis counseling, suicide-prevention, medical, or in-home care service. KinCare360 may send family/safety contacts non-medical family follow-up notices when a caller shares an everyday concern, request, missed check-in, or coordination need that may require family attention. These notices do not mean Lily verified an emergency or medical issue, and KinCare360 cannot guarantee help will arrive. They mean a caller shared something that may warrant family follow-up. In an emergency or immediate danger, call 911.</p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
            ...
            <li>Missed routines, appointments, or family follow-ups</li>
            <li>Failure to receive, forward, or act on a family follow-up notice shared by a caller</li>
