      ...
      <section className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
            ...
            <li>Medication administration, instructions, or management</li>
        ...
        <div>
          ...
          <p className="mt-2">In a medical emergency or immediate danger, call <strong>911</strong> immediately. If you or someone else is thinking about suicide, self-harm, or emotional crisis, call or text <strong>988</strong>. Do not rely on KinCare360 for emergency response or crisis counseling. KinCare360 cannot guarantee response times and is not equipped to handle medical emergencies, suicide prevention, crisis intervention, abuse investigations, or emergency dispatch. By using our services, you acknowledge that KinCare360 shall have no liability for delays in communication or inability to respond to emergencies or crisis situations.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">5. Urgent Safety Concern Notifications</h2>
          <p>KinCare360 is not an emergency, crisis counseling, suicide-prevention, medical, or in-home care service. However, if a caller shares information suggesting possible immediate harm, self-harm, abuse, neglect, severe confusion, exploitation, overdose or poisoning risk, or another urgent safety concern, KinCare360 may notify listed family/safety contacts and encourage the caller to contact 911, 988, Poison Control, or another appropriate human support resource.</p>
          <p className="mt-2">These notices do not mean Lily verified an emergency or crisis, or can guarantee help will arrive. They mean a caller shared something concerning during a Lily call and a family/safety contact should follow up.</p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">7. Subscriptions, Free Trial & Payments</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">9. Limitation of Liability</h2>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
            ...
            <li>Failure to receive, forward, or act on a safety concern shared by a caller</li>
        ...
        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">10. Indemnification</h2>
        ...
        <div>
          ...
          <p>Account owners may consent during signup/intake. Family members provide their own consent at <a href="https://www.kincare360.com/family-consent" className="text-teal underline">https://www.kincare360.com/family-consent</a> after being added to a family profile. By submitting the applicable SMS consent form, you expressly agree to receive recurring automated SMS messages from KinCare360 at the phone number provided. Messages include daily check-in notifications, family-approved routine reminders, appointment updates, family concern notifications, urgent safety concern notices, daily summaries, and service alerts.</p>
          <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">12. Governing Law</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-navy mb-2">13. Changes to Terms</h2>
